    ...
    <div class="popup-inner">
      <div class="popup-close-btn">
        ...
        <ul class="popup-tag-list">
          ...
          ${projects[i].technologies[i + 0]}</li>
          <li class="tag-items popup-feature">
          ${projects[i].technologies[i + 1]}</li>
          <li class="tag-items popup-feature">
          ${projects[i].technologies[i + 2]}</li>
        </ul>
      </div>
      <div class="popup-info">
        <img id="popup-image" class="popup-image" src="
        ${projects[i].image}" alt="post image">
        <div class="popup-info-holder">
          ...
          <div class="popup-btn-holder">
            ...
            ${projects[i].source_link}">See source
